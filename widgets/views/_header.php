...
<header id="pageTop" class="header">
	...
	<div class="container">
		...
		<img style="width:171px;" src="/img/logo.svg" alt="zaimovik.info" title="ZAIMOVIK.INFO"/>
	    </a>

	    <div class="navbar-collapse">
		<ul class="navbar-nav ml-auto">
		    <li class="nav-item <?=$main_category_alias==''?'active':'';?>">
			<a class="nav-link" href="/"><span class="sr-only">(current)</span>Главная</a>
		    </li>
		    <li class="nav-item dropdown drop_single <?=$main_category_alias=='banki'?'active':'';?>">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">Банки</a>
			<ul class="dropdown-menu dd_first">
			    <?php foreach($banki_items as $banki_item){ ?>
			    <li><a href="/<?=$banki_item->ALIAS;?>/"><?=$banki_item->NAME;?></a></li>
			    <?php } ?>
		    ...
		    <li class="nav-item dropdown drop_single <?=$main_category_alias=='mfo'?'active':'';?>">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">МФО</a>
			<ul class="dropdown-menu dd_first">
			    <?php foreach($mfo_items as $mfo_item){ ?>
			    <li><a href="/<?=$mfo_item->ALIAS;?>/"><?=$mfo_item->NAME;?></a></li>
			    <?php } ?>
		    ...
		    <li class="nav-item dropdown drop_single <?=$main_category_alias=='services'?'active':'';?>">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">Сервисы</a>
			<ul class="dropdown-menu dd_first">
			    <li><a href="/calc/credit/">Кредитный калькулятор</a></li>
			    <li><a href="/calc/ipoteka/">Ипотечный калькулятор</a></li>
			    <li><a href="/calc/compare/">Сравнение кредитов</a></li>
			    <li><a href="javascript:void(0);">Подбор кредита</a></li>
			    <li><a href="javascript:void(0);">Подбор займа</a></li>
			    <li><a href="javascript:void(0);">Подбор кредитной карты</a></li>
			</ul>
		    </li>
		    <li class="nav-item dropdown drop_single ">
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">Блог</a>
			<ul class="dropdown-menu dd_first">
			    <li><a href="/method/online-zaim-na-kartu/">Кредит онлайн на карту</a></li>
			...
			<a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="javascript:void(0)">Полезное</a>
			<ul class="row dropdown-menu">
			    <li class="col-md-3 col-12">
				<h6>Займы студентам</h6>
