			...
			<div class="col-md-3">
				<div class="footer-text">
					<a href="/">
						...
						<img class="footer-logo" src="/img/logo.svg" alt="zaimovik.info" title="ZAIMOVIK.INFO"/>
					</a>
					<p>
						Онлайн-сервис по подбору кредитов и микрозаймов в России.
					</p>
					<div class="social-icons">
						<a href="#" class="btn btn-social btn-social-o vk">
							<i class="fa fa-vk"></i>
						</a>
						<a href="#" class="btn btn-social btn-social-o facebook">
							<i class="fa fa-facebook-f"></i>
						</a>
						<a href="#" class="btn btn-social btn-social-o odnoklassniki">
			...
			<div class="col-xl-2 col-md-2">
				<div class="links">
					...
					<ul class="">
						...
						<li><a href="page-aboutus.html">О нас</a></li>
						<li><a href="services-1.html">Сервисы</a></li>
						<!--<li><a href="portfolio-3-column.html">Портфолио</a></li>-->
						<li><a href="blog-classic-left-sidebar.html">Блог</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md-3">
				<div class="location">
					...
					<ul>
						<li></li>
						<li><i class="fa fa-home"></i> Москва, Российская Федерация</li>
						<!--<li><i class="fa fa-phone"></i> <a href="tel:"></a></li>-->
						<li><i class="fa fa-envelope"></i> <a href="mailto:support@zaimovik.info"> support@zaimovik.info </a></li>
					</ul>
				</div>
			</div>
			<!--<div class="col-md-4">
				<div class="instagram">
					...
					<ul class="row instagram-image">
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta1.jpg" alt="insta"></a></li>
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta2.jpg" alt="insta"></a></li>
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta3.jpg" alt="insta"></a></li>
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta4.jpg" alt="insta"></a></li>
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta5.jpg" alt="insta"></a></li>
						<li class="col-xs-4 col-4"><a href="#"><img data-original="/img/home/footer/insta6.jpg" alt="insta"></a></li>
					</ul>
				</div>
			</div>-->
			...
			<div class="row justify-content-center">
				<div class="col-sm-6">
					<div class="copyRight_text text-center">
						<p> &copy; <?=date('Y');?> ZAIMOVIK.INFO Все права защищены.</p>
					</div>
				</div>
			</div>
		</div>
