    ...
    <section class="bredcrumb">
	    ...
	    <div class="">
		    <ul class="pager middle">
			    <li>Главная</li>
			    <li><a href="javascript:void(0)">Кредитный калькулятор</a></li>
		    </ul>
	    </div>
    </section>
	...
	<div class="container">
		<div class="row">
				...
				<div class="service_single-details">
					...
					<form class="register" method="post" id="frm-calc">
						<div class="form-group row">
							...
							<div class="col-md-6">
								<input id="SUM" name="SUM" class="form-control" type="text" placeholder="Сумма кредита" value="300000">
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input id="TERM" name="TERM" class="form-control" type="number" placeholder="Срок кредита" value="36">
							</div>
						</div>
						<div class="form-group row">
							<label for="PERCENT" class="col-md-2 col-form-label">Процентная ставка (% в год):</label>
							<div class="col-md-8">
								<input id="PERCENT" name="PERCENT" class="form-control" placeholder="Процентная ставка" value="17.5">
							</div>	
						</div>
						<div class="form-group row">
			...
			<div class="col-lg-3 col-md-4 order-1 sidebar hidden-xs">
				<ul class="list-group">					
					<li class="list-group-item active"><a href="/calc/credit/">Кредитный калькулятор</a></li>
