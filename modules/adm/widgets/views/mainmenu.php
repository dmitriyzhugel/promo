<nav class="navbar-default navbar-static-side" role="navigation">
	...
	<ul class="nav metismenu" id="side-menu">
		...
		<div class="dropdown profile-element"> <span>
			<img alt="image" class="img-circle" src="/img/admin/profile_small.jpg" />
		    </span>
		...
		<a href="<?=$item['href'];?>"><i class="<?=$item['icon'];?>"></i> <span class="nav-label"><?=$item['text'];?></span><span class="fa arrow"></span></a>
		<?php if(isset($item['subnav']) && !empty($item['subnav'])){ ?>
		<ul class="nav nav-second-level collapse">
		    <?php foreach($item['subnav'] as $sub_item){ ?>
